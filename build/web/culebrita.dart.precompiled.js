...
["culebrita_juego", "juego.dart", , Y, {
  ...
  Juego: {
    ...
    _loop$1: [function(delta) {
      ...
      if (typeof t2 !== "number")
        return H.iae(t2);
      if (t1 - t2 > 170) {
        this.jugando = !this._serpiente.mover$1(this._frutas);
        this._dibujar$0();
        this._tiempo = t1;
      }
      if (this.jugando)
        C.Window_methods.get$animationFrame(window).then$1(this.get$_loop());
    }, "call$1", "get$_loop", 2, 0, 14],
    _dibujar$0: function() {
      var t1 = this._ctx;
  ...
  Juego_closure: {
    "^": "Closure:15;this_0",
    call$1: function(e) {
      if (J.get$keyCode$x(e) === 38)
        this.this_0._serpiente.cambiarDireccion$1(2);
      if (e.keyCode === 40)
        this.this_0._serpiente.cambiarDireccion$1(3);
      if (e.keyCode === 39)
        this.this_0._serpiente.cambiarDireccion$1(0);
      if (e.keyCode === 37)
        this.this_0._serpiente.cambiarDireccion$1(1);
    }
  },
  Juego__dibujar_closure: {
    "^": "Closure:10;this_0",
    call$1: function(fruta) {
      var t1, t2, t3;
      t1 = this.this_0;
      t2 = t1._ctx;
      t1 = t1._colores;
  ...
  Serpiente: {
    ...
    mover$1: function(frutas) {
      ...
      for (t1 = new H.ListIterator(frutas, 2, 0, null); t1.moveNext$0();) {
        fruta = t1._current;
        if (fruta.get$_x() === nx && fruta._y === ny) {
          this._crecer = this._crecer + (fruta.get$tipo() + 1) * 2;
          fruta._x = fruta._random.nextInt$1(32);
          fruta._y = fruta._random.nextInt$1(24);
          fruta._tipo = fruta._random.nextInt$1(3);
        }
      }
    ...
    cambiarDireccion$1: function(nuevaDir) {
      var t1;
      switch (nuevaDir) {
        case 2:
        case 3:
...
function dart_precompiled($collectedClasses) {
  ...
  function Cuadro(_x, _y) {
    this._x = _x;
    this._y = _y;
  }
  Cuadro.builtin$cls = "Cuadro";
  if (!"name" in Cuadro)
    Cuadro.name = "Cuadro";
  $desc = $collectedClasses.Cuadro;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  Fruta.builtin$cls = "Fruta";
  if (!"name" in Fruta)
    Fruta.name = "Fruta";
  $desc = $collectedClasses.Fruta;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Fruta.prototype = $desc;
  function Juego(_ctx, jugando, _tiempo, _serpiente, _frutas, _colores, _random) {
    this._ctx = _ctx;
    this.jugando = jugando;
    this._tiempo = _tiempo;
    this._serpiente = _serpiente;
    this._frutas = _frutas;
    this._colores = _colores;
    this._random = _random;
  }
  Juego.builtin$cls = "Juego";
  if (!"name" in Juego)
    Juego.name = "Juego";
  $desc = $collectedClasses.Juego;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Juego.prototype = $desc;
  function Juego_closure(this_0) {
    this.this_0 = this_0;
  }
  Juego_closure.builtin$cls = "Juego_closure";
  if (!"name" in Juego_closure)
    Juego_closure.name = "Juego_closure";
  $desc = $collectedClasses.Juego_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Juego_closure.prototype = $desc;
  function Juego__dibujar_closure(this_0) {
    this.this_0 = this_0;
  }
  Juego__dibujar_closure.builtin$cls = "Juego__dibujar_closure";
  if (!"name" in Juego__dibujar_closure)
    Juego__dibujar_closure.name = "Juego__dibujar_closure";
  $desc = $collectedClasses.Juego__dibujar_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  if (!"name" in Serpiente)
    Serpiente.name = "Serpiente";
  $desc = $collectedClasses.Serpiente;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Serpiente.prototype = $desc;
